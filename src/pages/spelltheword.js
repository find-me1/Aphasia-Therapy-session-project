...
const therapyQuestions = {
  day1: [{ Q: "MOUNTAIN" }, { Q: "RIVER" }, { Q: "FOREST" }, { Q: "OCEAN" }],
  day2: [
    { Q: "CITY" },
    { Q: "TOWN" },
    { Q: "VILLAGE" },
...
const pageloadspeech = [
  { Q: "Listen to the question and spell it aloud." },
      ...
      const reminder = () => {
        if (!correctAnswerGiven) {
          const reminderSpeech = new SpeechSynthesisUtterance(
            `Hi there! It's time to spell the question: ${question.Q}`
          );
          const voice = window.speechSynthesis
            .getVoices()
            .find(
